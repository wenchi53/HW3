...
; <label>:2                                       ; preds = %10, %0
  ...
  %4 = icmp slt i32 %3, 4, !dbg !25
  br i1 %4, label %5, label %13, !dbg !26

; <label>:5                                       ; preds = %2
  %6 = load i32, i32* %i, align 4, !dbg !27
  %7 = load i32, i32* %i, align 4, !dbg !29
  %8 = sext i32 %7 to i64, !dbg !30
  %9 = getelementptr inbounds [3 x i32], [3 x i32]* %numbers, i64 0, i64 %8, !dbg !30
  store i32 %6, i32* %9, align 4, !dbg !31
  br label %10, !dbg !32
...
!1 = !DIFile(filename: "test_programs/test_array.c", directory: "/home/llvm/hw3-OutofBounds_Checking")
!2 = !{}
!3 = !{!4}
...
!11 = !DILocalVariable(name: "numbers", scope: !4, file: !1, line: 2, type: !12)
!12 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7, size: 96, align: 32, elements: !13)
!13 = !{!14}
!14 = !DISubrange(count: 3)
!15 = !DIExpression()
!16 = !DILocation(line: 2, column: 7, scope: !4)
!17 = !DILocalVariable(name: "i", scope: !4, file: !1, line: 3, type: !7)
!18 = !DILocation(line: 3, column: 7, scope: !4)
!19 = !DILocation(line: 4, column: 9, scope: !20)
!20 = distinct !DILexicalBlock(scope: !4, file: !1, line: 4, column: 3)
!21 = !DILocation(line: 4, column: 7, scope: !20)
!22 = !DILocation(line: 4, column: 14, scope: !23)
!23 = !DILexicalBlockFile(scope: !24, file: !1, discriminator: 1)
!24 = distinct !DILexicalBlock(scope: !20, file: !1, line: 4, column: 3)
!25 = !DILocation(line: 4, column: 15, scope: !23)
!26 = !DILocation(line: 4, column: 3, scope: !23)
!27 = !DILocation(line: 5, column: 18, scope: !28)
!28 = distinct !DILexicalBlock(scope: !24, file: !1, line: 4, column: 23)
!29 = !DILocation(line: 5, column: 13, scope: !28)
!30 = !DILocation(line: 5, column: 5, scope: !28)
!31 = !DILocation(line: 5, column: 16, scope: !28)
!32 = !DILocation(line: 6, column: 3, scope: !28)
!33 = !DILocation(line: 4, column: 20, scope: !34)
!34 = !DILexicalBlockFile(scope: !24, file: !1, discriminator: 2)
!35 = !DILocation(line: 4, column: 3, scope: !34)
